  ...
  return (
    <div className="relative">
      <button 
        ...
        className="relative p-2 rounded-lg bg-[var(--bg-card)] border border-[var(--border)] text-muted hover:text-primary hover:border-primary transition-all duration-200"
      >
        <Bell size={18} />
        {unreadCount > 0 && (
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute right-0 mt-2 w-80 bg-[var(--bg-card)]/95 backdrop-blur-xl border border-primary/20 rounded-xl shadow-2xl overflow-hidden z-50 origin-top-right text-left"
          >
            ...
            <div className="max-h-[300px] overflow-y-auto hide-scrollbar p-2">
              <div className="p-3 bg-[#111827] rounded-lg mb-2 cursor-pointer border border-[var(--border)] hover:border-primary/50 transition-colors">
