...
const SubscriptionStatus = () => {
  ...
  const planInfo = {
    free: { name: 'Recruit', color: 'text-muted', icon: Zap, bg: 'bg-bg-card' },
  ...
  return (
    <div className="max-w-4xl mx-auto py-10 px-4 space-y-8">
      ...
      <div className="flex items-center gap-4 mb-10 pb-6 border-b border-border">
         ...
         <div>
            <h1 className="font-display font-bold text-3xl text-primary tracking-widest uppercase">CLEARANCE <span className="text-primary">CHECKER</span></h1>
            <p className="font-mono text-[10px] text-muted tracking-[4px] uppercase mt-1">Verifying node credentials against distributed ledger</p>
         </div>
      </div>
      ...
      {isScanning ? (
        <div className="bg-bg-card border border-border rounded-3xl p-20 flex flex-col items-center justify-center gap-6 relative overflow-hidden">
           ...
           <div className="space-y-2 text-center">
              ...
              <div className="font-mono text-[10px] text-muted uppercase">Querying Block: {blockNumber}</div>
           </div>
        ...
        >
          ...
          <div className={`relative border border-border rounded-3xl p-8 md:p-12 overflow-hidden ${currentPlan.bg}`}>
             ...
             <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="text-center md:text-left space-y-4">
                   <div className="inline-flex items-center gap-2 px-3 py-1 bg-bg-primary border border-border rounded-full font-mono text-[10px] font-bold text-muted tracking-widest uppercase">
                   ...
                   <p className="font-mono text-sm text-secondary max-w-md uppercase tracking-wide leading-relaxed">
                ...
                <div className="bg-bg-primary/50 backdrop-blur-md border border-border p-6 rounded-2xl w-full md:w-72 space-y-4 shadow-xl">
                   <div className="flex justify-between items-center pb-3 border-b border-border">
                      <span className="font-mono text-[10px] text-muted uppercase font-bold tracking-widest flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             <div className="bg-bg-card border border-border p-8 rounded-3xl">
                <h3 className="font-display font-bold text-lg text-primary uppercase tracking-widest mb-6 flex items-center gap-3">
                ...
                <ul className="space-y-4">
                   {getBenefits(userData.plan).map((benefit, i) => (
                      <li key={i} className="flex items-start gap-3">
                         ...
                         <span className="font-mono text-[11px] text-secondary uppercase tracking-widest">{benefit}</span>
                      </li>
                   ))}
                </ul>
             </div>
