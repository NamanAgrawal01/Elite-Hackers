  ...
  return (
    <div className="max-w-7xl mx-auto py-10 animate-fade-in-up relative">
          ...
          <div className="relative bg-[#0d1117] border border-primary/30 rounded-3xl p-8 max-w-sm w-full text-center shadow-[0_0_50px_rgba(0,255,136,0.2)] animate-float">
            ...
            <div className="space-y-3">
              ...
              <button 
                ...
                className="w-full py-2 font-mono text-[10px] text-muted hover:text-white transition-colors uppercase tracking-widest"
              >
                Cancel Transmission
              </button>
            </div>
      ...
      <div className="text-center mb-16 px-4">
         <h1 className="font-display font-bold text-4xl text-primary tracking-widest uppercase mb-4">SECURITY <span className="text-primary glow-green">CLEARANCE TIERS</span></h1>
         <p className="font-mono text-sm text-muted tracking-widest uppercase max-w-2xl mx-auto mb-6">Upgrade your node. All payments are verified manually by the Owner for maximum security.</p>
          ...
          return (
            ...
            >
               ...
               <div className="mb-8 flex items-end gap-1">
                  ...
                  {plan.period && <span className="font-mono text-muted mb-1 text-[10px] uppercase ml-1">{plan.period}</span>}
               </div>
                  ...
                  <ul className="space-y-4 mb-8">
                     {plan.features.map((feat, i) => (
                        <li key={i} className="flex items-start gap-3">
                           ...
                           <span className="font-mono text-[10px] text-secondary leading-relaxed uppercase tracking-widest">{feat}</span>
                        </li>
                     ))}
                  </ul>
               </div>
