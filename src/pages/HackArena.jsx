           ...
           <div className="bg-[#0b0404] border border-red/30 p-10 rounded-2xl max-w-md w-full text-center relative overflow-hidden glow-red">
               ...
               <div className="bg-[var(--bg-primary)] border border-border p-6 rounded-xl mb-8">
                  ...
                  <div className="flex justify-between items-center">
                     <span className="font-mono text-[10px] text-muted tracking-widest uppercase">Peak Streak</span>
        ...
        <div className="min-h-[calc(100vh-140px)] flex items-center justify-center animate-fade-in-up px-4">
           ...
           <div className="bg-[var(--bg-primary)] border border-[var(--border)] max-w-4xl w-full rounded-2xl flex flex-col md:flex-row overflow-hidden relative group glow-cyan">
              ...
              <div className="md:w-1/2 p-10 flex flex-col justify-center relative z-10 border-r border-[var(--border)]">
                 ...
                 <h1 className="font-display font-bold text-4xl text-primary tracking-widest uppercase mb-4">HACK ARENA</h1>
              ...
              <div className="md:w-1/2 bg-[#0a0d14] p-10 relative z-10">
                 ...
                 <ul className="space-y-6">
                    <li className="flex gap-4 items-start">
                       ...
                       <div>
                          <p className="font-mono text-xs font-bold text-primary uppercase tracking-widest mb-1">Defense Grid (3 Lives)</p>
                          <p className="font-mono text-[10px] text-secondary leading-relaxed">Three incorrect answers trigger a system lockdown. Protect your connection.</p>
                       </div>
                    </li>
                    <li className="flex gap-4 items-start">
                       <Zap size={20} className="text-cyan shrink-0" />
                       <div>
                          <p className="font-mono text-xs font-bold text-primary uppercase tracking-widest mb-1">Dynamic Multiplier</p>
                          <p className="font-mono text-[10px] text-secondary leading-relaxed">Successive correct answers scale XP gains exponentially up to 3.0x.</p>
                       </div>
                    </li>
                    <li className="flex gap-4 items-start">
                       <Award size={20} className="text-gold shrink-0" />
                       <div>
                          <p className="font-mono text-xs font-bold text-primary uppercase tracking-widest mb-1">Extraction</p>
                          <p className="font-mono text-[10px] text-secondary leading-relaxed">XP is securely extracted and applied to your main profile upon termination.</p>
                       </div>
                    </li>
                 </ul>
              </div>
    ...
    <div className="max-w-4xl mx-auto py-10 animate-fade-in-up">
      ...
      <div className="flex flex-wrap justify-between items-end mb-8 gap-4 bg-[#0a0d14] border border-[var(--border)] p-4 rounded-xl">
         ...
         <div className="text-center">
            <span className="font-mono text-[10px] text-muted tracking-widest uppercase font-bold block mb-1">MULTIPLIER</span>
      ...
      >
         ...
         <h2 className="font-display font-bold text-2xl text-primary tracking-wide mb-8 leading-relaxed mt-4">
            {q.q}
         </h2>
